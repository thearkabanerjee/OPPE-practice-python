def swap_except_middle_three(s: str) -> str:
    """
    Given an odd-length string, swap the parts before and after the middle 
    three characters, while keeping the middle three characters in place.
    Assume the string has at least 5 characters.

    Examples:
        "firstabelast1" -> "lastlabcfirst"
        "abcdefghi" -> "ghidefabc"
